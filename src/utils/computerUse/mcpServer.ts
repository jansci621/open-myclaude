...
let buildComputerUseTools: any = () => []
let createComputerUseMcpServer: any = null
try {
  // eslint-disable-next-line @typescript-eslint/no-require-imports
  const cuMcp = require('@ant/computer-use-mcp')
  buildComputerUseTools = cuMcp.buildComputerUseTools || buildComputerUseTools
  createComputerUseMcpServer = cuMcp.createComputerUseMcpServer
} catch {
