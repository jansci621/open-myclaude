...
let API_RESIZE_PARAMS: any = {}
let targetImageSize: any = () => ({ width: 1280, height: 720 })
try {
  // eslint-disable-next-line @typescript-eslint/no-require-imports
  const cuMcp = require('@ant/computer-use-mcp')
  API_RESIZE_PARAMS = cuMcp.API_RESIZE_PARAMS || API_RESIZE_PARAMS
  targetImageSize = cuMcp.targetImageSize || targetImageSize
} catch {
