...
import type { ComputerUseSessionContext, CuCallToolResult, CuPermissionRequest, CuPermissionResponse, ScreenshotDims } from '../../stubs/computerUse.js';
...
// Optional import for internal package
let bindSessionContext: any = null
let DEFAULT_GRANT_FLAGS: any = {}
try {
  // eslint-disable-next-line @typescript-eslint/no-require-imports
  const cuMcp = require('@ant/computer-use-mcp')
  bindSessionContext = cuMcp.bindSessionContext
  DEFAULT_GRANT_FLAGS = cuMcp.DEFAULT_GRANT_FLAGS || {}
} catch {
